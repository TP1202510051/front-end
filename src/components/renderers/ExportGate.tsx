...
interface ExportGateProps {
  ...
  /** El control de generacion. Solo se pinta con la puerta abierta. */
  children?: ReactNode
}
 ...
 * control de generacion entra aqui dentro, como hijo: asi no puede aparecer en la pantalla por un
 * camino que no pase por esta decision.
 *
...
export function ExportGate({ exportable, children }: ExportGateProps) {
  ...
  return <div className="space-y-2" data-testid="export-gate">
    {open
      ? children ?? <p role="status">Esta revisión ya es exportable.</p>
      : <>
